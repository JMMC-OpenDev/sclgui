...
* JMMC project
*
* "@(#) $Id: getInformation.C,v 1.2 2004-11-03 08:31:21 scetre Exp $"
*
* who       when         what
* --------  -----------  -------------------------------------------------------
...
static char *rcsId="@(#) $Id: getInformation.C,v 1.2 2004-11-03 08:31:21 scetre Exp $"; 
...
int main(int argc, char *argv[])
{
    ...
    *rec=0;
    ...
    for (i=1; i<argc-1; i++) 
    {strcat(rec,argv[i]); strcat(rec," ");} strcat(rec,argv[i]);
    }
    if (rec[0] == '\0') exit(0);
    strcat(rec,"!") ; 
