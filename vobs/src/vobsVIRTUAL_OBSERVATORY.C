 ...
 * JMMC project
 *
 * "@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.12 2004-09-13 07:00:15 scetre Exp $"
 *
 * who       when         what
 * --------  -----------  -------------------------------------------------------
...
static char *rcsId="@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.12 2004-09-13 07:00:15 scetre Exp $"; 
