 ...
 * JMMC project
 *
 * "@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.11 2004-09-07 11:56:53 scetre Exp $"
 *
 * who       when         what
 * --------  -----------  -------------------------------------------------------
...
static char *rcsId="@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.11 2004-09-07 11:56:53 scetre Exp $"; 
