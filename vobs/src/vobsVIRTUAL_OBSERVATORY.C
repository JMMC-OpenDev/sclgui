 ...
 * JMMC project
 *
 * "@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.22 2004-11-30 15:17:25 scetre Exp $"
 *
 * who       when         what
 * --------  -----------  -------------------------------------------------------
...
static char *rcsId="@(#) $Id: vobsVIRTUAL_OBSERVATORY.C,v 1.22 2004-11-30 15:17:25 scetre Exp $";
