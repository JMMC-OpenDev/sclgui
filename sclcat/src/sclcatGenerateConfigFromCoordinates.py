...
# JMMC project
#
# "@(#) $Id: sclcatGenerateConfigFromCoordinates.py,v 1.1 2010-02-10 14:00:27 lafrasse Exp $"
#
# History
# -------
...
def generateHeaderFromTemplate(filename):
    ...
    # Add script name
    outputBuffer = "# File generated by sclcatESOGenerateConfig"
    outputBuffer += "\n"
...
if len(sys.argv) != 4 :
    print 'Usage : sclcatESOGenerateConfig headerFilename coordinatesFilename outputFilename'
    sys.exit(1)
header      = sys.argv[1]
