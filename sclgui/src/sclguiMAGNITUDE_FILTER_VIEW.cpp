 ...
 * JMMC project
 *
 * "@(#) $Id: sclguiMAGNITUDE_FILTER_VIEW.cpp,v 1.5 2006-03-03 15:28:17 scetre Exp $"
 *
 * History
 * -------
...
static char *rcsId __attribute__ ((unused))="@(#) $Id: sclguiMAGNITUDE_FILTER_VIEW.cpp,v 1.5 2006-03-03 15:28:17 scetre Exp $"; 
...
mcsCOMPL_STAT sclguiMAGNITUDE_FILTER_VIEW::Update()
{
    ...
    vobsMAGNITUDE_FILTER *magFilter =
        ...
        _filterListModel->GetFilter("Magnitude Filter");
