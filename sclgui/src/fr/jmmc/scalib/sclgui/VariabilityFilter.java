 ...
 * JMMC project
 *
 * "@(#) $Id: VariabilityFilter.java,v 1.1 2006-04-07 13:32:23 yvander Exp $"
 *
 * History
 * -------
...
public class VariabilityFilter extends Filter
{
    ...
    public void process(StarList starList)
    {
        ...
        if (isEnabled() == true)
	//if ((isEnabled() == true) && (getVariability() == true))
        {
		...
		while (find != true && i < variabilityId.length)
		{
		    ...
		    if ((variabilityFlag != null) && (variabilityFlag.equals("") == false))
		    {
