 ...
 * JMMC project
 *
 * "@(#) $Id: sclguiVISIBILITY_FILTER_VIEW.cpp,v 1.6 2006-03-03 15:28:17 scetre Exp $"
 *
 * History
 * -------
...
static char *rcsId __attribute__ ((unused))="@(#) $Id: sclguiVISIBILITY_FILTER_VIEW.cpp,v 1.6 2006-03-03 15:28:17 scetre Exp $"; 
...
mcsCOMPL_STAT sclguiVISIBILITY_FILTER_VIEW::Update()
{
    ...
    sclsvrVISIBILITY_FILTER *visFilter = 
        ...
        _filterListModel->GetFilter("Visibility Filter");
