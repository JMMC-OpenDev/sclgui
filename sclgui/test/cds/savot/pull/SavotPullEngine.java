 ...
 * 
 * 
 * Note 22/11/2011: Laurent Bourges: optimized String allocations (TD tags) marked with tag (LBO)
 * 
 * 
*/
public class SavotPullEngine implements cds.savot.common.Markups {
  ...
  public SavotResource parse (XmlPullParser parser, int parsingType) throws IOException {
    ...
    // shared empty TD instance (LBO)
    final SavotTD emptyTD = new SavotTD();
    
    // optimize empty text values (LBO)
