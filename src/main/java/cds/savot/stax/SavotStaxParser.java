...
public final class SavotStaxParser implements Markups {
     ...
     * @throws javax.xml.stream.XMLStreamException
     */
    public SavotStaxParser(final String file, final int mode,
     ...
     * @throws javax.xml.stream.XMLStreamException
     */
    public SavotStaxParser(final InputStream instream, final int mode,
                           final boolean debug, final SavotStatistics stats) throws IOException, XMLStreamException {
    ...
    public SavotStaxParser(final Reader reader, final int mode,
                           final boolean debug) throws IOException, XMLStreamException {
    ...
    /**
     * Get the last element from the resource stack
    ...
    /**
     * Put a resource on the resource stack
     * @param resource
     */
    ...
    /**
     * Get the last element from the option stack
     * @return SavotOption
     */
    ...
    /**
     * Put an option on the option stack
     * @param option
     */
    ...
    /**
     * Get the last element from the group stack
     * @return SavotGroup
     */
    ...
    /**
     * Put a group on the group stack
     * @param group
     */
