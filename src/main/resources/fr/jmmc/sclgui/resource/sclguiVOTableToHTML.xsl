        ...
        <xsl:for-each select="$groups">
            <xsl:element name="mapping">
                <xsl:for-each select="./VOT:FIELDref">
                    ...
                    <xsl:variable name="fieldUnit"  select="$field/@unit"/>
                    <xsl:variable name="fieldDesc"  select="$field/VOT:DESCRIPTION/text()"/>
                    <xsl:choose>
                    ...
                    <xsl:if test="$fieldUnit">
                        <xsl:attribute name="unit">
                            <xsl:value-of select="$fieldUnit"/>
                        </xsl:attribute>
                    </xsl:if>
