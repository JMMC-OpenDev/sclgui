 ...
 * JMMC project
 *
 * "@(#) $Id: sclsvrSPECTRAL_TYPE_FILTER.h,v 1.1 2005-06-01 14:18:54 scetre Exp $"
 *
 * History
 * -------
...
public:
    ...
    virtual mcsCOMPL_STAT SetSpectralType(char **tempClassList);

    virtual mcsCOMPL_STAT GetSpectralType(char **tempClassList);
